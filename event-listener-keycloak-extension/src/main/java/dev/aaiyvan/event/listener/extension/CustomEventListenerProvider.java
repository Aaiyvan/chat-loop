package dev.aaiyvan.event.listener.extension;
...
import dev.aaiyvan.event.listener.extension.utils.PropertiesUtil;
...
/**
 * dev.aaiyvan.event.listener.extension.CustomEventListenerProvider is a class that implements the EventListenerProvider interface from Keycloak.
...
public class CustomEventListenerProvider implements EventListenerProvider {
  ...
  /**
   * Constructor for the dev.aaiyvan.event.listener.extension.CustomEventListenerProvider.
  ...
  public CustomEventListenerProvider(Producer<String, AuditEvent> producer) {
    ...
    log.info("dev.aaiyvan.event.listener.extension.CustomEventListenerProvider created");
  }
