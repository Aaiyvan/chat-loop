package dev.aaiyvan.event.listener.extension.factory;

import dev.aaiyvan.event.listener.extension.CustomEventListenerProvider;
import dev.aaiyvan.event.listener.extension.config.KafkaProducerCreator;
import dev.aaiyvan.event.listener.extension.model.dto.AuditEvent;
 ...
 * dev.aaiyvan.event.listener.extension.CustomEventListenerProvider. It implements the EventListenerProviderFactory interface from
...
public class CustomEventListenerProviderFactory implements EventListenerProviderFactory {
  ...
  /**
   * Creates a new instance of dev.aaiyvan.event.listener.extension.CustomEventListenerProvider using the Kafka producer.
   *
   * @param session the Keycloak session
   * @return a new instance of dev.aaiyvan.event.listener.extension.CustomEventListenerProvider
   */
  @Override
