package dev.aaiyvan.event.listener.extension.utils;
...
public class AuditEventSerializer implements Serializer<AuditEvent> {
   ...
   */
  @Override
  public byte[] serialize(final String topic, final AuditEvent data) {
    try {
      return objectMapper.writeValueAsBytes(data);
    } catch (Exception e) {
      throw new RuntimeException("Exception while serializing object AuditEvent", e);
    }
  }
}