...
import dev.aaiyvan.logginginfostarter.annotations.LoggableInfo;
...
public class LoggingMethodExecutionAspect {
    ...
    @Pointcut("(within(@dev.aaiyvan.logginginfostarter.annotations.LoggableInfo *) || execution(@dev.aaiyvan.logginginfostarter.annotations.LoggableInfo * *(..))) && execution(* *(..))")
