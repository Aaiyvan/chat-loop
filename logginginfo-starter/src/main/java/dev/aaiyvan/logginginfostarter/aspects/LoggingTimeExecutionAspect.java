package dev.aaiyvan.logginginfostarter.aspects;

import dev.aaiyvan.logginginfostarter.annotations.LoggableTime;
...
public class LoggingTimeExecutionAspect {
    ...
    @Pointcut("(within(@dev.aaiyvan.logginginfostarter.annotations.LoggableTime *) || execution(@dev.aaiyvan.logginginfostarter.annotations.LoggableTime * *(..))) && execution(* *(..))")
